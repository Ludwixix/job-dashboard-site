...
## Target Role: Tech Support roles
...
### Core Skills
Azure · Active Directory · Customer Support · Intune · Microsoft 365 · SharePoint · Entra ID · PowerShell · Exchange · Teams · Windows · Autopilot · ServiceNow · Security · CI/CD · Git · Documentation
...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Azure, Active Directory, Customer Support first; Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 704 | - Voice guide check: PASS |  -->
