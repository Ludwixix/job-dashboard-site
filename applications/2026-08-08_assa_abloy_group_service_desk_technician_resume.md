...
### Profile
The Oakleigh service-desk role matches my recent L1/L2 endpoint support, Windows troubleshooting, incident handling, hardware diagnostics and customer communication experience.

### Core Skills
Intune · Windows · ServiceNow · ITIL · Customer support · Hardware diagnostics · Windows 10/11 · Autopilot · Network and Layer 1 fault-finding · Fibre and copper cabling · Data-centre infrastructure fundamentals · HVAC and environmental controls · PowerShell · Technical documentation
