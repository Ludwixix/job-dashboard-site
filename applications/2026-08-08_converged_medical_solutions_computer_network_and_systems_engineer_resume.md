...
## Target Role: Computer Network and Systems Engineer
...
### Core Skills
Microsoft 365 · Network · Security · Customer Support · Entra ID · Intune · SharePoint · Azure · PowerShell · Exchange · Teams · Windows · Autopilot · ServiceNow · Active Directory · CI/CD · Git · Documentation
...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Microsoft 365, Network, Security first; Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 701 | - Voice guide check: PASS |  -->
