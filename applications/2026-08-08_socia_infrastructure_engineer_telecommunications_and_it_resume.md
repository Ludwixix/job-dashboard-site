...
### Profile
Contract infrastructure role covering telecommunications, network, compute, storage and virtualisation. NBN field experience and enterprise infrastructure support provide a credible base.

### Core Skills
Layer 1 networking · Azure · Microsoft 365 · Entra ID · Intune · Windows Autopilot · Windows 10/11 · PowerShell · Microsoft Graph · SharePoint · Exchange Online · Teams · Active Directory · ServiceNow · ITIL 4 · endpoint lifecycle · incident and problem management · RCA · technical documentation · stakeholder communication
