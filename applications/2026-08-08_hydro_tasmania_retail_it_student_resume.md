...
## Target Role: Retail IT Student

### Profile
Adzuna listing for Retail IT Student at Hydro Tasmania
...
<!-- ✅ Tailoring summary | - Match tier: Adjacent/stretch match | - Key changes from base resume: Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 688 | - Voice guide check: PASS |  -->
