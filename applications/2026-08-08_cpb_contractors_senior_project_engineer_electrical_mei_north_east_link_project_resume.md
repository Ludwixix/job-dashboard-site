...
## Target Role: Senior Project Engineer, Electrical - MEI | North East Link Project
...
### Core Skills
Entra ID · Microsoft 365 · SharePoint · Azure · Intune · PowerShell · Exchange · Teams · Windows · Autopilot · ServiceNow · Active Directory · Security · CI/CD · Git · Documentation
...
<!-- ✅ Tailoring summary | - Match tier: No match | - Key changes from base resume: Skills reordered: Entra ID first; Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 685 | - Voice guide check: PASS |  -->
