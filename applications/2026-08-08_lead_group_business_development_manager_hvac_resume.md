...
### Profile
Adzuna listing for Business Development Manager - HVAC at Lead Group
...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Network, HVAC first; Experience reordered: Telecommunications Technician first | - Requirements not fully addressed: none | - Word count: 696 | - Voice guide check: PASS |  -->
