...
**Re: Site Support Senior Technician — Computershare**

Dear Hiring Manager,

I’m applying for the Site Support Senior Technician position with Computershare. Office-based senior site-support role combining endpoint troubleshooting, user support, technical ownership and continuous learning in a large enterprise environment.
...
What appeals to me about the role is the combination of intune, customer support. I’d bring dependable task ownership, clear communication and a willingness to learn the way your team works.
