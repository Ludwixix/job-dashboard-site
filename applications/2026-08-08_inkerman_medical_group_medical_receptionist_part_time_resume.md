...
Melbourne-based professional seeking a practical local role in St Kilda and nearby suburbs. Brings dependable service-desk operations, customer communication, inventory control, field work, technical problem-solving, documentation and the ability to learn new procedures quickly. Open to a local-work transition and ready to learn the role’s procedures.

### Profile
My service-centre and healthcare project experience provides transferable customer communication, scheduling, documentation, privacy-conscious support and clinical-environment familiarity. I haven’t worked as a medical receptionist before.

### Core Skills
Healthcare technology · Customer support · Customer service · Clear communication · Reliable task ownership · Inventory and asset control · Field work · Technical troubleshooting · Process compliance · Documentation · Team collaboration · Fast learning · Microsoft 365 and digital systems
