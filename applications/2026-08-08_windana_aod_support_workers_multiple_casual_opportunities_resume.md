...
## Target Role: AOD Support Workers - Multiple Casual Opportunities

### Profile
Indeed listing for AOD Support Workers - Multiple Casual Opportunities at Windana
...
### Core Skills
ServiceNow · Customer Support · Microsoft 365 · SharePoint · Azure · Entra ID · Intune · PowerShell · Exchange · Teams · Windows · Autopilot · Active Directory · Security · CI/CD · Git · Documentation
...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: ServiceNow, Customer Support first; Experience reordered: L2/L3 Technical Support Engineer first | - Requirements not fully addressed: none | - Word count: 698 | - Voice guide check: PASS |  -->
