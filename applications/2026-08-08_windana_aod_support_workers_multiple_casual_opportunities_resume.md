...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: ServiceNow, Customer Support first; Experience reordered: L2/L3 Technical Support Engineer first | - Requirements not fully addressed: none | - Word count: 684 | - Voice guide check: PASS |  -->
