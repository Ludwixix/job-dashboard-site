...
**Re: Senior DevOps Engineer — FMClarity**

Dear Hiring Manager,

I’m applying for the Senior DevOps Engineer position with FMClarity. Fresh Melbourne SaaS infrastructure role in a facilities and maintenance platform. A stretch toward DevOps, but aligned with cloud operations, automation, troubleshooting and service improvement.
...
What appeals to me about the role is the combination of powershell, data-centre operations, customer support. I’d bring dependable task ownership, clear communication and a willingness to learn the way your team works.
