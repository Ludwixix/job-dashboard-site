...
## Target Role: IT Operations Technician

### Profile
Adzuna listing for IT Operations Technician at Hays
...
### Core Skills
Security · Microsoft 365 · SharePoint · Azure · Entra ID · Intune · PowerShell · Exchange · Teams · Windows · Autopilot · ServiceNow · Active Directory · CI/CD · Git · Documentation
...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Security first; Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 687 | - Voice guide check: PASS |  -->
