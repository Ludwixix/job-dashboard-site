...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Security first; Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 677 | - Voice guide check: PASS |  -->
