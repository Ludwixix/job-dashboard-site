...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Data Centre first; Experience reordered: HVAC Service Technician first | - Requirements not fully addressed: none | - Word count: 680 | - Voice guide check: PASS |  -->
