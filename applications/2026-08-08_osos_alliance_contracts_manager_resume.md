...
### Profile
Adzuna listing for Contracts Manager at OSOS Alliance
...
### Core Skills
Teams · Microsoft 365 · SharePoint · Azure · Entra ID · Intune · PowerShell · Exchange · Windows · Autopilot · ServiceNow · Active Directory · Security · CI/CD · Git · Documentation
...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Teams first; Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 686 | - Voice guide check: PASS |  -->
