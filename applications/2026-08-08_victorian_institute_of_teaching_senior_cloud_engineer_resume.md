...
### Core Skills
Microsoft 365 · Azure · Entra ID · PowerShell · Active Directory · SharePoint · Intune · Exchange · Teams · Windows · Autopilot · ServiceNow · Security · CI/CD · Git · Documentation
...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Microsoft 365, Azure first; Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 677 | - Voice guide check: PASS |  -->
