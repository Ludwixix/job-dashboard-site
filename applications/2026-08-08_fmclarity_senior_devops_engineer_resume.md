...
### Profile
Fresh Melbourne SaaS infrastructure role in a facilities and maintenance platform. A stretch toward DevOps, but aligned with cloud operations, automation, troubleshooting and service improvement.

### Core Skills
PowerShell · Data-centre operations · Customer support · Azure · Microsoft 365 · Entra ID · Intune · Windows Autopilot · Windows 10/11 · Microsoft Graph · SharePoint · Exchange Online · Teams · Active Directory · ServiceNow · ITIL 4 · endpoint lifecycle · incident and problem management · RCA · technical documentation · stakeholder communication
