...
<!-- ✅ Tailoring summary | - Match tier: Adjacent/stretch match | - Key changes from base resume: Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 678 | - Voice guide check: PASS |  -->
