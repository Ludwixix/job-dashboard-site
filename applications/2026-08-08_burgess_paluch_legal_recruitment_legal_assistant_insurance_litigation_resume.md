...
## Target Role: Legal Assistant- Insurance Litigation

### Profile
Adzuna listing for Legal Assistant- Insurance Litigation at Burgess Paluch Legal Recruitment
...
<!-- ✅ Tailoring summary | - Match tier: Adjacent/stretch match | - Key changes from base resume: Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 692 | - Voice guide check: PASS |  -->
