...
## Target Role: Manager, Support & Delivery Teams

### Profile
Adzuna listing for Manager, Support & Delivery Teams at Halcyon Knights
...
### Core Skills
Teams · Customer Support · Microsoft 365 · SharePoint · Azure · Entra ID · Intune · PowerShell · Exchange · Windows · Autopilot · ServiceNow · Active Directory · Security · CI/CD · Git · Documentation
...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Teams, Customer Support first; Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 695 | - Voice guide check: PASS |  -->
