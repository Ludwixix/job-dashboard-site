...
### Profile
This role aligns with my Azure, Microsoft 365, Entra ID, endpoint and escalation experience, supported by PowerShell, Graph and ITIL 4 practices.

### Core Skills
Azure · Microsoft 365 · Entra ID · Intune · PowerShell · ITIL · Windows Autopilot · Windows 10/11 · Microsoft Graph · SharePoint · Exchange Online · Teams · Active Directory · ServiceNow · ITIL 4 · endpoint lifecycle · incident and problem management · RCA · technical documentation · stakeholder communication
