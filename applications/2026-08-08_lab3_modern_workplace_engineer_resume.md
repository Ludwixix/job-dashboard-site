...
### Profile
This role matches my Microsoft 365, Intune, Autopilot, Windows, Entra ID, automation and managed-services escalation experience.

### Core Skills
Microsoft 365 · Entra ID · Intune · Windows · Autopilot · PowerShell · Customer support · Azure · Windows Autopilot · Windows 10/11 · Microsoft Graph · SharePoint · Exchange Online · Teams · Active Directory · ServiceNow · ITIL 4 · endpoint lifecycle · incident and problem management · RCA · technical documentation · stakeholder communication
