...
## Target Role: eLearning Engagement & IT Support Officer

### Profile
Adzuna listing for eLearning Engagement & IT Support Officer at Acknowledge Education
...
### Core Skills
Teams · Git · Customer Support · Compliance · Microsoft 365 · SharePoint · Azure · Entra ID · Intune · PowerShell · Exchange · Windows · Autopilot · ServiceNow · Active Directory · Security · CI/CD · Documentation
...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Teams, Git, Customer Support first; Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 699 | - Voice guide check: PASS |  -->
