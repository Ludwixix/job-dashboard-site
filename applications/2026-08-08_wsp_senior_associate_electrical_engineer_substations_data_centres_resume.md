...
<!-- ✅ Tailoring summary | - Match tier: No match | - Key changes from base resume: Skills reordered: Data Centre first; Experience reordered: HVAC Service Technician first | - Requirements not fully addressed: none | - Word count: 685 | - Voice guide check: PASS |  -->
