...
<!-- ✅ Tailoring summary | - Match tier: No match | - Key changes from base resume: Skills reordered: Customer Support first; Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 678 | - Voice guide check: PASS |  -->
