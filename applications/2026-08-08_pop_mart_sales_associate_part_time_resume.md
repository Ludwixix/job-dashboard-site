...
## Target Role: Sales Associate (Part-Time)
...
### Profile
LinkedIn listing for Sales Associate (Part-Time) at POP MART
...
<!-- ✅ Tailoring summary | - Match tier: No match | - Key changes from base resume: Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 686 | - Voice guide check: PASS |  -->
