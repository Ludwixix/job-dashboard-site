...
### Profile
Office-based senior site-support role combining endpoint troubleshooting, user support, technical ownership and continuous learning in a large enterprise environment.

### Core Skills
Intune · Customer support · Azure · Microsoft 365 · Entra ID · Windows Autopilot · Windows 10/11 · PowerShell · Microsoft Graph · SharePoint · Exchange Online · Teams · Active Directory · ServiceNow · ITIL 4 · endpoint lifecycle · incident and problem management · RCA · technical documentation · stakeholder communication
