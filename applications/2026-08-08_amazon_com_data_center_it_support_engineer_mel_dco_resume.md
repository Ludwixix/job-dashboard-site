...
### Core Skills
Intune · Data Centre · Customer Support · ITIL · Microsoft 365 · SharePoint · Azure · Entra ID · PowerShell · Exchange · Teams · Windows · Autopilot · ServiceNow · Active Directory · Security · CI/CD · Git · Documentation
...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Intune, Data Centre, Customer Support first | - Requirements not fully addressed: none | - Word count: 710 | - Voice guide check: PASS |  -->
