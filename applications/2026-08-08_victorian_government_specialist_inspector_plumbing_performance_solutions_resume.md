...
## Target Role: Specialist Inspector, Plumbing - Performance Solutions
...
### Core Skills
Compliance · Azure · Microsoft 365 · Entra ID · PowerShell · SharePoint · Intune · Exchange · Teams · Windows · Autopilot · ServiceNow · Active Directory · Security · CI/CD · Git · Documentation
...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Compliance first; Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 682 | - Voice guide check: PASS |  -->
