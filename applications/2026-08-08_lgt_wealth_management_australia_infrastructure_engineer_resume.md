...
### Core Skills
Microsoft 365 · Entra ID · Azure · Windows · PowerShell · Documentation · ITIL · SharePoint · Intune · Exchange · Teams · Autopilot · ServiceNow · Active Directory · Security · CI/CD · Git
...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Microsoft 365, Entra ID, Azure first; Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 707 | - Voice guide check: PASS |  -->
