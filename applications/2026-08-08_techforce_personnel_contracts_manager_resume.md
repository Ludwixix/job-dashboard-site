...
## Target Role: Contracts Manager

### Profile
Adzuna listing for Contracts Manager at Techforce Personnel
...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Network first; Experience reordered: Telecommunications Technician first | - Requirements not fully addressed: none | - Word count: 688 | - Voice guide check: PASS |  -->
