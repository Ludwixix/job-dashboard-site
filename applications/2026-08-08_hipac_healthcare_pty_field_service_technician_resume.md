...
## Target Role: Field Service Technician

### Profile
Adzuna listing for Field Service Technician at Hipac Healthcare Pty
...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Customer Support first; Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 692 | - Voice guide check: PASS |  -->
