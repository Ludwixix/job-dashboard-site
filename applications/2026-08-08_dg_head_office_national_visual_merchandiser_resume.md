...
## Target Role: National Visual Merchandiser

### Profile
Adzuna listing for National Visual Merchandiser at DG Head Office
...
### Core Skills
Microsoft 365 · Teams · Network · SharePoint · Azure · Entra ID · Intune · PowerShell · Exchange · Windows · Autopilot · ServiceNow · Active Directory · Security · CI/CD · Git · Documentation
...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Microsoft 365, Teams, Network first; Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 691 | - Voice guide check: PASS |  -->
