...
## Target Role: Project Engineer, Mechanical - MEI | North East Link Project
...
<!-- ✅ Tailoring summary | - Match tier: No match | - Key changes from base resume: Skills reordered: Entra ID first; Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 684 | - Voice guide check: PASS |  -->
