...
### Profile
This role aligns with my experience supporting secure enterprise infrastructure across Windows, Microsoft 365, Entra ID, endpoints, PowerShell and service operations.

### Core Skills
Microsoft 365 · Entra ID · Intune · Windows · PowerShell · Customer support · Azure · Windows Autopilot · Windows 10/11 · Microsoft Graph · SharePoint · Exchange Online · Teams · Active Directory · ServiceNow · ITIL 4 · endpoint lifecycle · incident and problem management · RCA · technical documentation · stakeholder communication
