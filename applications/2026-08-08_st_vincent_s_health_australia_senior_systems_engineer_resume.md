...
### Profile
Senior systems role supporting and scaling critical healthcare infrastructure. Strong overlap with enterprise Microsoft, endpoint, identity and service-operations experience.

### Core Skills
Entra ID · Intune · Healthcare technology · Customer support · Azure · Microsoft 365 · Windows Autopilot · Windows 10/11 · PowerShell · Microsoft Graph · SharePoint · Exchange Online · Teams · Active Directory · ServiceNow · ITIL 4 · endpoint lifecycle · incident and problem management · RCA · technical documentation · stakeholder communication
