...
## Target Role: Microsoft Cloud Solutions Consultant
...
### Core Skills
Azure · Microsoft 365 · Entra ID · PowerShell · SharePoint · Intune · Exchange · Teams · Windows · Autopilot · ServiceNow · Active Directory · Security · CI/CD · Git · Documentation
...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Azure first; Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 696 | - Voice guide check: PASS |  -->
