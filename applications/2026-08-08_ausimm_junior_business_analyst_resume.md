...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Git first; Experience reordered: SharePoint Developer first | - Requirements not fully addressed: none | - Word count: 677 | - Voice guide check: PASS |  -->
