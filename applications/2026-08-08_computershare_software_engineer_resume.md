...
### Profile
Adzuna listing for Software Engineer at Computershare
...
<!-- ✅ Tailoring summary | - Match tier: Strong match | - Key changes from base resume: Skills reordered: Customer Support first; Experience reordered: Senior Managed Services Engineer first | - Requirements not fully addressed: none | - Word count: 688 | - Voice guide check: PASS |  -->
