...
**Re: Sales Associate (Part-Time) — POP MART**

Dear Hiring Manager,

I'm writing to express my interest in the Sales Associate (Part-Time) position with POP MART. I'm writing to express my interest in the Sales Associate (Part-Time) role at POP MART. My background across enterprise infrastructure, Microsoft 365, and service operations connects well with the requirements outlined.
...
<!-- ✅ Cover letter summary | - Specific listing details referenced: Role: Sales Associate (Part-Time); Company: POP MART; Location: Melbourne, Victoria, Australia | - Achievements highlighted: none | - Adjacent-match framing used: no | - Word count: 157 | - Voice guide check: PASS |  -->
